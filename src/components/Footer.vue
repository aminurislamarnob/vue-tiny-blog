          ...
          <div class="widget-item mt-0">
            <div class="about-widget">
              <a class="footer-logo" href="index.html">
                <img height="55" src="../assets/logo.png" alt="Logo" />
              </a>
            </div>
        ...
        <div class="col-md-6 col-lg-4 col-xl-4">
          <div class="widget-item sm-pl-0 pl-70">
            ...
            <ul class="widget-contact-info">
              ...
              <li class="info-mail"><a href="mailto:aminur.arnob@gmail.com">aminur.arnob@gmail.com</a></li>
              <li class="info-phone"><a href="tel:">(000) 000-0000</a></li>
            </ul>
          </div>
        </div>
