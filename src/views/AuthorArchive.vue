<template>
  <BreadCrumb :title="'Blog Posts of ' + $route.params.name" pageName="Author Archive"></BreadCrumb>
...
export default {
  ...
  mounted() {
    axios
      .get(`https://works.aiarnob.com/blog-api/wp-json/wp/v2/posts?per_page=12&author=${this.id}`)
      .then((response) => {
